...
const elSupportBtn = document.getElementById("btnSupport");
...
function openSupportModal() {
  ...
  if (elSupportBtn) {
    elSupportBtn.setAttribute("aria-expanded", "true");
  }
}
...
function closeSupportModal() {
  ...
  if (elSupportBtn) {
    elSupportBtn.setAttribute("aria-expanded", "false");
  }
...
if (elSupportBtn) {
  elSupportBtn.addEventListener("click", () => {
