/* worker/assistant-template.js
   OPS GATEWAY (Template) — PUBLIC EDGE — NO TURNSTILE
...
export default {
  async fetch(request, env, ctx) {
    ...
    const ip_tag = await ipTagOf(env, clientIp);
    ...
    // 9) Forward upstream (NO TURNSTILE)
